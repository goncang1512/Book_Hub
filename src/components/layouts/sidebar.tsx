...
export default function SideBar({ seeSearch, setSeeSearch, searchButtonRef }: SideBarType) {
  ...
  return (
    <div
      className={`bg-white fixed md:flex hidden left-0 right-0 w-72 h-screen  border-r shadow-lg  flex-col gap-[30px] py-5 z-50`}
    >
      ...
      <div className="flex flex-col pt-[20px]">
        ...
        <div className="flex flex-col gap-2">
          ...
          >
            <Whislist color={`${pathname === "/profil/whislist" ? "#FFFFFF" : "#000"}`} size={19} />{" "}
            Whislist
          </Link>
      ...
      >
        ...
        <div className="flex flex-col gap-2">
          ...
          {session?.user && (
            ...
            >
              <Link className={`flex gap-2 items-center text-lg font-medium py-2`} href={`/profil`}>
                <LuUser size={20} />
                Profil
              </Link>
              <button
